    ...
    <div className="home">
      <div className="featured">
        <div className="featuredItem blue">
          ...
          <div className="featuredTitle bold">خدمات های اخیر</div>
          <div className="featuredDescription">
            تعداد خدمات های یک روز گذشته
          </div>
        ...
        <div className="featuredItem pink">
          ...
          <div className="featuredTitle bold"> ارزش دارایی تحت مدیریت </div>
          <div className="featuredDescription">
            تعداد ارزش دارایی های تحت مدیریت{" "}
          </div>
          <div className="featuredIconContainer">
        ...
        <div className="featuredItem yellow">
          ...
          <div className="featuredTitle bold">سازمان ثبت </div>
        ...
        <div className="featuredItem green">
          ...
          <div className="featuredTitle bold"> صندوق‌ سرمایه‌گذاری </div>
          <div className="featuredDescription">
            {" "}
      ...
      <div className="chartStat">
        <div className="chartBox big">
          <h3 className="chartTitle"> وضعیت سرمایه گذاری صبا جهاد </h3>
