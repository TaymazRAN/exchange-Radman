...
import MaliServices from "./services/MaliServices";
import ServicesInvest from "./services/ServicesInvest";
import ServicesSumSuppluymeny from "./services/ServicesSumSuppluymeny";
import ServicesRegisterCompany from "./services/ServicesRegisterCompany";
    ...
    <>
      ...
      <div className="widthFix small">
        <Routes>
          ...
          <Route path="/Vision" element={<Vision />} />
          <Route path="/Vision" element={<Vision />} />
          <Route path="/MaliServices" element={<MaliServices />} />
          <Route path="/ServicesInvest" element={<ServicesInvest />} />
          <Route path="/MaliServices" element={<MaliServices />} />
          <Route
            path="/ServicesRegisterCompany"
            element={<ServicesRegisterCompany />}
          />
          <Route
            path="/ServicesSumSuppluymeny"
            element={<ServicesSumSuppluymeny />}
          />
