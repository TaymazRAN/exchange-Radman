...
const Support = () => {
  const groupName = "Connect_Support";
          ...
          <Accordion className="customAccordion">
            ...
            >
              <div className="customQuestion">
                {" "}
                {item.title} <div className="customBorder"></div>{" "}
              </div>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                <div className="customAnswer"> {item.body}</div>
              </Typography>
            </AccordionDetails>
          </Accordion>
        ))
  ...
  return (
    <div className="page">
      <h2>چطور میتوانیم به شما کمک کنیم؟ سوالات متداول</h2>
      <div className="accordionContainer">
        <Accordion className="customAccordion">
          <div className="accordionContainer">
            <div className="compartment">
              <div className="data faq">{renderTitle}</div>
            </div>
          </div>
        </Accordion>
      </div>
