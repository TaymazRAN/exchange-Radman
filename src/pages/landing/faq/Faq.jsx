            ...
            <AccordionDetails>
              <Typography>
                <div className="faqAnswer">
                  <ul>
                    <li>
                      توصیه ی اصلی گروه مالی جهاد به این دسته از مشتریان عزیز،
                      داشتن رویکرد غیر مستقیم در سرمایه گذاری است، بدین معنا که
                      ضمن اعتماد به مدیران حرفه ای جهاد و یا سایر صندوق های
                      سرمایه گذاری معتبر در ایران، از خرید و فروش مستقیم سهام در
                      بازار بورس و ... خودداری کرده و سرمایه ی خود را در یک
                      صندوق سرمایه گذاری مطمئن قرار دهند
                    </li>
                    <li>
                      استفاده از ابزار پیشرفته ی مشاور هوشمند جهاد (موجود در
            ...
            <AccordionDetails>
              <Typography>
                <div className="faqAnswer">
                  ...
                  سود سرمایه شما) (صندوق سهامی جهاد)
                  <br />
                  در کمترین حالت ۱۰۸% سود معادل ۱/۰۴۰/۰۰۰/۰۰۰ تومان (اصل و سود
                  سرمایه شما) (صندوق درآمد ثابت جهاد)
                  <br />
                  در بازارهای موازی:
                  <br />
