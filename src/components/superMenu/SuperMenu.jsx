            ...
            <div className="d-content">
              <div className="d-row">
                <div className="d-column">
                  ...
                  <Link to="/static/MaliServices"> تامین مالی </Link>
                  <Link to="/static/ServicesInvest"> صندوق سرمایه گدازی </Link>
                  <Link to="/static/ServicesRegisterCompany">
                    {" "}
                    عرضه و پذیرش شرکت{" "}
                  </Link>
                  <Link to="/static/ServicesSumSuppluymeny">
                    {" "}
                    تامین مالی جمعی{" "}
                  </Link>
                ...
                <div className="d-column">
                  ...
                  {/* <Link to=""> ورود به سامانه آتی‌سهام </Link> */}
                  <Link to=" "> ورود به سامانه آتی کالا</Link>
                  <Link to="/static/servicesA4"> سوالات متداول</Link>
                  {/* <Link to="/static/ServicesC8"> */}
                  <Link> مشاهده آنلاین نمای بازار آتی کالا </Link>
                </div>
                <div className="d-column">
                  <h3>بورس انرژی</h3>
          ...
          <div className="d-content-container">
            <div className="d-content">
              <div className="d-row">
                ...
                <div className="d-column">
                  {/* <Link to="/static/PlatformA5">همراه تریدر آتی</Link> */}
