...
const url = `${configData.AddressApi}/identity/manager`;
...
export const slice = createSlice({
	...
	extraReducers: (builder) => {
		...
		builder.addCase(fetchOrganizationManagers.pending, (state, action) => {
			state.loading = true;
		});
		builder.addCase(fetchOrganizationManagers.fulfilled, (state, action) => {
			state.loading = false;
			state.data = action.payload;
			state.ready = true;
			state.error = "";
		});
		builder.addCase(fetchOrganizationManagers.rejected, (state, action) => {
			state.loading = false;
			state.ready = false;
			state.error = action.error.message;
		});
